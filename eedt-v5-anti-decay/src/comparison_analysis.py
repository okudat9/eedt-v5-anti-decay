...
ax1.set_title('Input: Fidelity (共通)', fontsize=14, fontweight='bold')
...
ax2.set_title('Input: Pass Rate (共通)', fontsize=14, fontweight='bold')
...
ax4.set_title('修正による改善量', fontsize=14, fontweight='bold', color='green')
...
plt.suptitle('🔬 オリジナル vs 修正版: SKR計算式の影響比較', 
             fontsize=18, fontweight='bold', y=0.995)
plt.tight_layout()

filename = '/home/claude/comparison_original_vs_corrected.png'
